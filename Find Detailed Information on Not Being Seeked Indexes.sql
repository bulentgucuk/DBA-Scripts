-- Find Detailed Information on Indexes not being seeked
DECLARE
	@SchemaName SysName,
	@TableName SysName,
	@Sort tinyint,
...
WHERE
	...
	AND (
			ISNULL(sys.dm_db_index_usage_stats.user_seeks,0) = 0
		AND (ISNULL(sys.dm_db_index_usage_stats.user_scans,0) = 0
		OR	ISNULL(sys.dm_db_index_usage_stats.user_lookups,0) = 0
		))
