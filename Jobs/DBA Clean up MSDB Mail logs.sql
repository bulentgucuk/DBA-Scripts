...
/****** Object:  Job [DBA Clean up MSDB Mail logs]    Script Date: 09/20/2011 09:43:52 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 09/20/2011 09:43:52 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBA Clean up MSDB Mail logs', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Delete 30 days older mail logs in msdb', 
		@category_name=N'Database Maintenance', 
		@owner_login_name=N'sa', 
		@notify_email_operator_name=N'DBA Group', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Delete 30 days older mail logs]    Script Date: 09/20/2011 09:43:52 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Delete 30 days older mail logs', 
		...
		@schedule_uid=N'360de4de-79dc-416c-92ba-a4dc5946680d'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
