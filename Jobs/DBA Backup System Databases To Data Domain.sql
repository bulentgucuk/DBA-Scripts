...
/****** Object:  Job [DBA Backup System Databases To Data Domain]    Script Date: 09/20/2011 11:44:56 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 09/20/2011 11:44:56 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBA Backup System Databases To Data Domain', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Backup System Databases (Master, Model, MSDB)', 
		@category_name=N'[Uncategorized (Local)]', 
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Connect to Data Domain]    Script Date: 09/20/2011 11:44:56 ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Backup System Databases]    Script Date: 09/20/2011 11:44:56 ******/
...
WHILE	@RowId > 0
	BEGIN
		...
		SELECT	@Str = ''''
		SELECT	@Str = ''BACKUP DATABASE ''+ DbName + '' TO DISK = ''''\\10.60.120.140\Backup\SPDBXX0028\SystemDatabases\''+ DbName +
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Disconnect from Data Domain]    Script Date: 09/20/2011 11:44:56 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Backup System Dbs', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@active_start_time=182500, 
		@active_end_time=235959, 
		@schedule_uid=N'ccaa958d-57fb-4769-aaf8-f6f6deacc05e'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
