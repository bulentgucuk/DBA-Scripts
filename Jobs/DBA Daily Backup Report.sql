...
/****** Object:  Job [DBA Daily Backup Report]    Script Date: 09/20/2011 09:14:21 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 09/20/2011 09:14:21 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBA Daily Backup Report', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Daily backup report]    Script Date: 09/20/2011 09:14:21 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Daily backup report', 
		@step_id=1, 
...
Create table BKUPWORK4 (subsys_name char(20),server_name varchar(20), env_name char(20),
 ...
 Values(''BKUPPRDBUS01'',''spdbxx0001\BUS01'',''Business'');
	Insert dbo.BKUPWORK4
 Values(''BKUPPRDBO02'',''spdbxx0008\BO02'',''BackOffice'');
	Insert dbo.BKUPWORK4
 Values(''BKUPPRDODS'',''spdbxx0028\ODS02'',''ODS'');
	Insert dbo.BKUPWORK4
 Values(''BKUPPRDBOK'',''SPDBXX0005\WEB02'',''WEB02'');
	Insert dbo.BKUPWORK4
...
exec msdb.dbo.sp_send_dbmail 
	--@profile_name = ''backupdist'',
	@recipients = ''gucuk@netquote.com'', @subject = ''Daily backup report'', 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Daily Job Reporting', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=60, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'ee4e63c4-6900-4820-9202-2eccc3383d95'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
