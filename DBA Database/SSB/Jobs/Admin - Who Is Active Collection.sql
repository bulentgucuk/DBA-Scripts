...
/****** Object:  Job [Admin - Who Is Active Collection]    Script Date: 6/30/2020 6:12:20 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 6/30/2020 6:12:20 PM ******/
...
select @jobId = job_id from msdb.dbo.sysjobs where (name = N'Admin - Who Is Active Collection')
if (@jobId is NULL)
BEGIN
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Admin - Who Is Active Collection', 
		@enabled=1, 
...
END
/****** Object:  Step [Start Job Step]    Script Date: 6/30/2020 6:12:21 PM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Start Job Step', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Admin_WhoIsActive Collection]    Script Date: 6/30/2020 6:12:21 PM ******/
...
DROP TABLE [dbo].[WhoIsActive_Temp];', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [CPU Utilization Collection]    Script Date: 6/30/2020 6:12:21 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Prune dbo.WhoisActive And dbo.CpuUtilization]    Script Date: 6/30/2020 6:12:21 PM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'_Admin_WhoIsActive Collection', 
		...
		@schedule_uid=N'3ae7b598-ba55-4629-85d3-0e8fbe6c41d9'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
