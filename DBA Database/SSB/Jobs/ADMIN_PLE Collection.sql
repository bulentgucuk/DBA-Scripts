...
/****** Object:  Job [ADMIN_PLE Collection]    Script Date: 6/23/2020 7:58:10 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 6/23/2020 7:58:10 PM ******/
...
select @jobId = job_id from msdb.dbo.sysjobs where (name = N'ADMIN_PLE Collection')
if (@jobId is NULL)
BEGIN
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'ADMIN_PLE Collection', 
		@enabled=1, 
...
END
/****** Object:  Step [Start Job Step 1]    Script Date: 6/23/2020 7:58:10 PM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Start Job Step 1', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [PLE Collection]    Script Date: 6/23/2020 7:58:10 PM ******/
...
AND counter_name = N''Page life expectancy'' OPTION (RECOMPILE);', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Clean up records older than 60 days]    Script Date: 6/23/2020 7:58:10 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'ADMIN_PLE Collection', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=4, 
		...
		@schedule_uid=N'56ce91fb-1a29-4f5d-a53a-7756bd8b376c'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
