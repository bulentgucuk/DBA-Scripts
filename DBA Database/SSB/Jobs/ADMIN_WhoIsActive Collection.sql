...
/****** Object:  Job [ADMIN_WhoIsActive Collection]    Script Date: 6/23/2020 8:00:49 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 6/23/2020 8:00:49 PM ******/
...
select @jobId = job_id from msdb.dbo.sysjobs where (name = N'ADMIN_WhoIsActive Collection')
if (@jobId is NULL)
BEGIN
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'ADMIN_WhoIsActive Collection', 
		@enabled=1, 
...
END
/****** Object:  Step [Start Job Step]    Script Date: 6/23/2020 8:00:49 PM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Start Job Step', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [CPU Utilization Collection]    Script Date: 6/23/2020 8:00:49 PM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Admin_WhoIsActive Collection]    Script Date: 6/23/2020 8:00:49 PM ******/
...
DROP TABLE [dbo].[WhoIsActive_Temp];', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Prune dbo.WhoisActive And dbo.CpuUtilization]    Script Date: 6/23/2020 8:00:49 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'ADMIN_WhoIsActive Collection', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=4, 
		...
		@schedule_uid=N'47713be7-b62e-448f-9d2c-e832c501d1ec'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
