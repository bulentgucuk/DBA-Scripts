...
/****** Object:  StoredProcedure [dbo].[sp_sizing]    Script Date: 3/14/2019 6:26:02 PM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_sizing]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[sp_sizing] AS' 
END
GO


ALTER PROCEDURE [dbo].[sp_sizing] @granularity 
