...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_DBA_GetTablePartitionInfo]') AND type in (N'P', N'PC'))
	EXEC( 'CREATE PROCEDURE [dbo].[sp_DBA_GetTablePartitionInfo] AS' );
GO
...
ALTER PROCEDURE [dbo].[sp_DBA_GetTablePartitionInfo] (
...
---------------------------------------------------------------------------------------
-- Procedure Name: sp_DBA_GetTablePartitionInfo
