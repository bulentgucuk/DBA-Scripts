...
ELSEif ($workstation -eq 'SSB008541382357')
{
    ...
    . "C:\SourceControl\ssb-devops\PowerShell\SQL Deployment Scripts\Build-SQLChangeAutomationProject.ps1"
...
if ($result -eq $true)
{
   ...
   Deploy-SQLChangeAutomationProject `
        -DatabaseServer 'l2oqghb8m9.database.windows.net' `
        -DatabaseName 'SSBRPProduction' `
