<#
    ...
    #When using SQL authentication to store and send the credentials not in clear text
...
Param(
	...
	[Parameter(Mandatory = $false)] 						  #When using SQL authentication to store and send the credentials not in clear text
...
IF ($DatabaseServer -like "*.windows.net")
	{
	Invoke-Sqlcmd `
